...
class MyTheme {
  ...
  static const String appName = "Divine Homes";
  static const String appVersion = "v. 0.0.1";

  static String fcmTopicName = "homerentaltopic";
  static String serverKeyFCM =
      'AAAA0ATYZ3A:APA91bHDmRuuChLyfzi2PdRZlGjTAieURJPHFVyjNQ1zR42StdEihZkbo2WIC9hSEzDWtCQSPFa7BJJ7VIbbgWOYl4RAjY5HupITuYzwFkYPlAAKIbvhRH3cc-3b-zTCwAcx8Jm1UFnD';

  static const String webSite = "https://dev-app.divingrace.com/";
  static String urlTermService = "https://dev-app.divingrace.com/";
  static String urlPolicy = 'https://dev-app.divingrace.com/policy.html';

  static String contentToShare =
      "HomeRental - Seamless space booking. \n\nWebsite: https://dev-app.divingrace.com @Copyrights 2022, DIVINGRACE LLC\n";
  ...
  static String noWA = "+971045842416";
...
const colorBoxShadow = Color(0xFFc48331); //Color(0xffe2e2e2)
